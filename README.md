# nvim-treesitter-queries-firrtl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-firrtl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-firrtl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **firrtl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-firrtl",
...
- [ ] Changes are scoped to `firrtl` — do not include files for other languages
